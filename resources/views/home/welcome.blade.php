            ...
            <div class="card">
                <div class="card-main">
                    <div class="card-inner">
                        ...
                        <p>
                            <a href ="{{ url('auth/social').'?platform=github' }}"><span class="icon icon-5x"><i class="fa fa-github"></i></span></a>
                            or &nbsp;
                            <a href="{{ url('auth/social').'?platform=weibo'}}"><span class="icon icon-5x text-red"><i class="fa fa-weibo"></i></span></a>
                        </p>
                    </div>
                </div>
            </div>
